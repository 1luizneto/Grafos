...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Testes para o Algoritmo de Prim e Kruskall
        self.g_pk = MeuGrafo()
        self.g_pk.adiciona_vertice("AX")
        self.g_pk.adiciona_vertice("BX")
        self.g_pk.adiciona_vertice("XA")
        self.g_pk.adiciona_vertice("XB")
        self.g_pk.adiciona_aresta("u1", "AX", "BX", 7)
        self.g_pk.adiciona_aresta("u2", "AX", "XA", 5)
        self.g_pk.adiciona_aresta("u3", "AX", "XB", 2)
        self.g_pk.adiciona_aresta("u4", "XB", "XA", 1)
        self.g_pk.adiciona_aresta("u5", "XB", "BX", 3)
        self.g_pk.adiciona_aresta("u6", "BX", "AX", 4)

        self.g_pkResolvido = MeuGrafo()
        self.g_pkResolvido.adiciona_vertice("AX")
        self.g_pkResolvido.adiciona_vertice("XB")
        self.g_pkResolvido.adiciona_vertice("XA")
        self.g_pkResolvido.adiciona_vertice("BX")
        self.g_pkResolvido.adiciona_aresta('u3', 'AX', 'XB', 2)
        self.g_pkResolvido.adiciona_aresta('u4', 'XB', 'XA', 1)
        self.g_pkResolvido.adiciona_aresta('u5', 'XB', 'BX', 3)

        self.g_pk2 = MeuGrafo()
        self.g_pk2.adiciona_vertice("A")
        self.g_pk2.adiciona_vertice("B")
        self.g_pk2.adiciona_vertice("C")
        self.g_pk2.adiciona_vertice("D")
        self.g_pk2.adiciona_vertice("E")
        self.g_pk2.adiciona_vertice("F")
        self.g_pk2.adiciona_vertice("G")
        self.g_pk2.adiciona_aresta("u1", "A", "B", 24)
        self.g_pk2.adiciona_aresta("u2", "A", "E", 18)
        self.g_pk2.adiciona_aresta("u3", "A", "F", 14)
        self.g_pk2.adiciona_aresta("u4", "F", "D", 28)
        self.g_pk2.adiciona_aresta("u5", "F", "G", 16)
        self.g_pk2.adiciona_aresta("u6", "G", "E", 12)
        self.g_pk2.adiciona_aresta("u7", "E", "B", 22)
        self.g_pk2.adiciona_aresta("u8", "B", "C", 25)
        self.g_pk2.adiciona_aresta("u9", "C", "D", 10)

        self.g_pk2Resolvido = MeuGrafo()
        self.g_pk2Resolvido.adiciona_vertice("A")
        self.g_pk2Resolvido.adiciona_vertice("F")
        self.g_pk2Resolvido.adiciona_vertice("G")
        self.g_pk2Resolvido.adiciona_vertice("E")
        self.g_pk2Resolvido.adiciona_vertice("B")
        self.g_pk2Resolvido.adiciona_vertice("C")
        self.g_pk2Resolvido.adiciona_vertice("D")
        self.g_pk2Resolvido.adiciona_aresta("u3", "A", "F", 14)
        self.g_pk2Resolvido.adiciona_aresta("u5", "F", "G", 16)
        self.g_pk2Resolvido.adiciona_aresta("u6", "G", "E", 12)
        self.g_pk2Resolvido.adiciona_aresta("u7", "E", "B", 22)
        self.g_pk2Resolvido.adiciona_aresta("u8", "B", "C", 25)
        self.g_pk2Resolvido.adiciona_aresta("u9", "C", "D", 10)

        self.g_pk3 = MeuGrafo()
        self.g_pk3.adiciona_vertice("1")
        self.g_pk3.adiciona_vertice("2")
        self.g_pk3.adiciona_vertice("3")
        self.g_pk3.adiciona_vertice("4")
        self.g_pk3.adiciona_vertice("5")
        self.g_pk3.adiciona_vertice("6")
        self.g_pk3.adiciona_vertice("7")
        self.g_pk3.adiciona_vertice("8")
        self.g_pk3.adiciona_vertice("9")
        self.g_pk3.adiciona_aresta('a1', '1', '2', 1)
        self.g_pk3.adiciona_aresta('a2', '2', '4', 10)
        self.g_pk3.adiciona_aresta('a3', '3', '2', 8)
        self.g_pk3.adiciona_aresta('a4', '2', '3', 8)
        self.g_pk3.adiciona_aresta('a5', '2', '4', 2)
        self.g_pk3.adiciona_aresta('a6', '2', '6', 3)
        self.g_pk3.adiciona_aresta('a7', '2', '5', 1)
        self.g_pk3.adiciona_aresta('a8', '5', '6', 2)
        self.g_pk3.adiciona_aresta('a9', '8', '6', 1)
        self.g_pk3.adiciona_aresta('a10', '7', '6', 3)
        self.g_pk3.adiciona_aresta('a11', '8', '7', 2)
        self.g_pk3.adiciona_aresta('a12', '8', '9', 10)

        self.g_pk3Resolvido = MeuGrafo()
        self.g_pk3Resolvido.adiciona_vertice("1")
        self.g_pk3Resolvido.adiciona_vertice("2")
        self.g_pk3Resolvido.adiciona_vertice("3")
        self.g_pk3Resolvido.adiciona_vertice("4")
        self.g_pk3Resolvido.adiciona_vertice("5")
        self.g_pk3Resolvido.adiciona_vertice("6")
        self.g_pk3Resolvido.adiciona_vertice("7")
        self.g_pk3Resolvido.adiciona_vertice("8")
        self.g_pk3Resolvido.adiciona_vertice("9")
        self.g_pk3Resolvido.adiciona_aresta('a1', '1', '2', 1)
        self.g_pk3Resolvido.adiciona_aresta('a7', '2', '5', 1)
        self.g_pk3Resolvido.adiciona_aresta('a9', '8', '6', 1)
        self.g_pk3Resolvido.adiciona_aresta('a11', '8', '7', 2)
        self.g_pk3Resolvido.adiciona_aresta('a5', '2', '4', 2)
        self.g_pk3Resolvido.adiciona_aresta('a8', '5', '6', 2)
        self.g_pk3Resolvido.adiciona_aresta('a3', '3', '2', 8)
        self.g_pk3Resolvido.adiciona_aresta('a12', '8', '9', 10)

        self.g_pk4 = MeuGrafo()
        self.g_pk4.adiciona_vertice("A")
        self.g_pk4.adiciona_vertice("B")
        self.g_pk4.adiciona_vertice("C")
        self.g_pk4.adiciona_vertice("D")
        self.g_pk4.adiciona_vertice("E")
        self.g_pk4.adiciona_vertice("F")
        self.g_pk4.adiciona_vertice("G")
        self.g_pk4.adiciona_vertice("H")
        self.g_pk4.adiciona_vertice("I")
        self.g_pk4.adiciona_vertice("J")
        self.g_pk4.adiciona_vertice("K")
        self.g_pk4.adiciona_aresta("1", "A", "B", 10)
        self.g_pk4.adiciona_aresta("2", "A", "G", 10)
        self.g_pk4.adiciona_aresta("3", "A", "J", 3)
        self.g_pk4.adiciona_aresta("4", "K", "G", 1)
        self.g_pk4.adiciona_aresta("5", "K", "J", 6)
        self.g_pk4.adiciona_aresta("6", "J", "G", 7)
        self.g_pk4.adiciona_aresta("7", "J", "I", 5)
        self.g_pk4.adiciona_aresta("8", "I", "G", 1)
        self.g_pk4.adiciona_aresta("9", "G", "H", 1)
        self.g_pk4.adiciona_aresta("10", "H", "F", 6)
        self.g_pk4.adiciona_aresta("11", "F", "B", 10)
        self.g_pk4.adiciona_aresta("12", "B", "G", 12)
        self.g_pk4.adiciona_aresta("13", "B", "C", 2)
        self.g_pk4.adiciona_aresta("14", "D", "B", 1)
        self.g_pk4.adiciona_aresta("15", "E", "B", 1)

        self.g_pk4Resolvido = MeuGrafo()
        self.g_pk4Resolvido.adiciona_vertice("D")
        self.g_pk4Resolvido.adiciona_vertice("B")
        self.g_pk4Resolvido.adiciona_vertice("E")
        self.g_pk4Resolvido.adiciona_vertice("K")
        self.g_pk4Resolvido.adiciona_vertice("G")
        self.g_pk4Resolvido.adiciona_vertice("I")
        self.g_pk4Resolvido.adiciona_vertice("H")
        self.g_pk4Resolvido.adiciona_vertice("C")
        self.g_pk4Resolvido.adiciona_vertice("A")
        self.g_pk4Resolvido.adiciona_vertice("J")
        self.g_pk4Resolvido.adiciona_vertice("F")
        self.g_pk4Resolvido.adiciona_aresta('14', 'D', 'B', 1)
        self.g_pk4Resolvido.adiciona_aresta('15', 'E', 'B', 1)
        self.g_pk4Resolvido.adiciona_aresta('4', 'K', 'G', 1)
        self.g_pk4Resolvido.adiciona_aresta('8', 'I', 'G', 1)
        self.g_pk4Resolvido.adiciona_aresta('9', 'G', 'H', 1)
        self.g_pk4Resolvido.adiciona_aresta('13', 'B', 'C', 2)
        self.g_pk4Resolvido.adiciona_aresta('3', 'A', 'J', 3)
        self.g_pk4Resolvido.adiciona_aresta('7', 'J', 'I', 5)
        self.g_pk4Resolvido.adiciona_aresta('10', 'H', 'F', 6)
        self.g_pk4Resolvido.adiciona_aresta('1', 'A', 'B', 10)

        self.g_pk5 = MeuGrafo()
        self.g_pk5.adiciona_vertice("0")
        self.g_pk5.adiciona_vertice("1")
        self.g_pk5.adiciona_vertice("2")
        self.g_pk5.adiciona_vertice("3")
        self.g_pk5.adiciona_vertice("4")
        self.g_pk5.adiciona_vertice("5")
        self.g_pk5.adiciona_vertice("6")
        self.g_pk5.adiciona_vertice("7")
        self.g_pk5.adiciona_vertice("8")
        self.g_pk5.adiciona_aresta("q1", "0", "1", 4)
        self.g_pk5.adiciona_aresta("q2", "0", "7", 8)
        self.g_pk5.adiciona_aresta("q3", "1", "2", 8)
        self.g_pk5.adiciona_aresta("q4", "1", "7", 11)
        self.g_pk5.adiciona_aresta("q5", "2", "3", 7)
        self.g_pk5.adiciona_aresta("q6", "2", "5", 4)
        self.g_pk5.adiciona_aresta("q7", "2", "8", 2)
        self.g_pk5.adiciona_aresta("q8", "3", "4", 9)
        self.g_pk5.adiciona_aresta("q9", "3", "5", 14)
        self.g_pk5.adiciona_aresta("q10", "4", "5", 10)
        self.g_pk5.adiciona_aresta("q11", "5", "6", 2)
        self.g_pk5.adiciona_aresta("q12", "6", "7", 1)
        self.g_pk5.adiciona_aresta("q13", "6", "8", 6)
        self.g_pk5.adiciona_aresta("q14", "7", "8", 7)

        self.g_p5Resolvido = MeuGrafo()
        self.g_p5Resolvido.adiciona_vertice("6")
        self.g_p5Resolvido.adiciona_vertice("7")
        self.g_p5Resolvido.adiciona_vertice("5")
        self.g_p5Resolvido.adiciona_vertice("2")
        self.g_p5Resolvido.adiciona_vertice("8")
        self.g_p5Resolvido.adiciona_vertice("3")
        self.g_p5Resolvido.adiciona_vertice("0")
        self.g_p5Resolvido.adiciona_vertice("1")
        self.g_p5Resolvido.adiciona_vertice("4")
        self.g_p5Resolvido.adiciona_aresta('q12', '6', '7', 1)
        self.g_p5Resolvido.adiciona_aresta('q11', '5', '6', 2)
        self.g_p5Resolvido.adiciona_aresta('q6', '2', '5', 4)
        self.g_p5Resolvido.adiciona_aresta('q7', '2', '8', 2)
        self.g_p5Resolvido.adiciona_aresta('q5', '2', '3', 7)
        self.g_p5Resolvido.adiciona_aresta('q2', '0', '7', 8)
        self.g_p5Resolvido.adiciona_aresta('q1', '0', '1', 4)
        self.g_p5Resolvido.adiciona_aresta('q8', '3', '4', 9)

        self.g_k5Resolvido = MeuGrafo()
        self.g_k5Resolvido.adiciona_vertice("6")
        self.g_k5Resolvido.adiciona_vertice("7")
        self.g_k5Resolvido.adiciona_vertice("5")
        self.g_k5Resolvido.adiciona_vertice("2")
        self.g_k5Resolvido.adiciona_vertice("8")
        self.g_k5Resolvido.adiciona_vertice("3")
        self.g_k5Resolvido.adiciona_vertice("0")
        self.g_k5Resolvido.adiciona_vertice("1")
        self.g_k5Resolvido.adiciona_vertice("4")
        self.g_k5Resolvido.adiciona_aresta('q12', '6', '7', 1)
        self.g_k5Resolvido.adiciona_aresta('q11', '5', '6', 2)
        self.g_k5Resolvido.adiciona_aresta('q6', '2', '5', 4)
        self.g_k5Resolvido.adiciona_aresta('q7', '2', '8', 2)
        self.g_k5Resolvido.adiciona_aresta('q5', '2', '3', 7)
        self.g_k5Resolvido.adiciona_aresta('q2', '0', '7', 8)
        self.g_k5Resolvido.adiciona_aresta('q1', '0', '1', 4)
        self.g_k5Resolvido.adiciona_aresta('q8', '3', '4', 9)
        self.g_k5Resolvido.adiciona_aresta("q14", "7", "8", 7)
        self.g_k5Resolvido.adiciona_aresta("q13", "6", "8", 6)
    ...
    def test_primModificado(self):
        self.assertEqual(self.g_pk.primModificado(), self.g_pkResolvido)
        self.assertEqual(self.g_pk2.primModificado(), self.g_pk2Resolvido)
        self.assertEqual(self.g_pk3.primModificado(), self.g_pk3Resolvido)
        self.assertEqual(self.g_pk4.primModificado(), self.g_pk4Resolvido)
        self.assertEqual(self.g_pk5.primModificado(), self.g_p5Resolvido)

    def test_kruskallModificado(self):
        self.assertEqual(self.g_pk.kruskallModificado(), self.g_pkResolvido)
        self.assertEqual(self.g_pk2.kruskallModificado(), self.g_pk2Resolvido)
        self.assertEqual(self.g_pk3.kruskallModificado(), self.g_pk3Resolvido)
        self.assertEqual(self.g_pk4.kruskallModificado(), self.g_pk4Resolvido)
        self.assertEqual(self.g_pk5.kruskallModificado(), self.g_k5Resolvido)
